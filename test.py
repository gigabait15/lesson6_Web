            ...
            <div class="card mb-4 rounded-3 shadow-sm">
                <div class="card-header py-3">
                    <p class="d-inline-flex gap-2">
                        <a class="w-100 col-3 btn btn-mb  btn-primary" data-bs-toggle="collapse"
                           href="#multiCollapseExample1"
                           role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Как купить?</a>
                        <button class="w-100 col-3 btn btn-mb  btn-primary" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample1">
                                <div class="card card-body">
                                    Добавить данные, отправить, нажать на кнопку купить.
                                </div>
                            </div>
                        </div>
                        <div class="col">
                            <div class="collapse multi-collapse" id="multiCollapseExample2">
                                <div class="card card-body">
                                    Доставка любой транспортной компанией.
                                </div>
                            </div>
                        </div>
                        <div class="col">
